...
function sitenamePopup (feature, layer) {
    ...
    layer.bindPopup("Site Name: " + 
        caps(name.toLowerCase())); 
...
// creating popups for toponym locations    
//function toponymPopup (feature, layer) {
//    var name = feature.properties.Name
//    layer.bindPopup("Toponym Category: " + name  
//        ); 
                   
    //layer.setIcon(templeIcon); //use the toponym icon
//};//end popup function 
    
    
   //adding sites to map ... this is one way but makes layer groups a pain
 //  $.getJSON('data/Sites_Points_GEO.json', function (data) {
    // Assign the results to the geojsonData variable
//   var arqPoints = L.geoJson(data, {onEachFeature: sitenamePopup})
...
function districtPopup(feature, layer) {
      var popupContent = "District: " + feature.properties.NOMBPROV;
